...
<html>
	...
	<body>
			...
			<div>
				<div>
					...
					<div style="margin:0 auto; margin-top:10px;width:950px;">
						<strong style="font-size:16px;margin:5px 0;color:orange;font-size:25px" >零食网购物车</strong><br>
						<strong style="font-size:16px;padding-top:10px 0;" >全部商品</strong>
				...
				<div style="margin-right:130px;">
					...
					&nbsp;&nbsp;
				</em>&nbsp; 总价: <strong style="color:#ff6600;">￥${cart.total }元</strong>
					</div>
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						<a href="javascript:;" onclick="clearCart()" id="clear" class="clear">清空购物车</a>
						<a href="order_info.htm">
							<input type="submit" width="100" value="提交订单" name="submit" border="0" src=Imag/submit.png";
		...
		<c:if test="${empty cart.cartItems }">
			<div>
				<img alt="" src="${pageContext.request.contextPath }/Imag/empty.png">
